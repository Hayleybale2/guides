...
* __Terminal Emulator__: [Gnome Terminal](https://gitlab.gnome.org/GNOME/gnome-terminal)`C++` -> [Lxterminal](https://github.com/lxde/lxterminal)`C` -> [Sakura](https://launchpad.net/sakura)`C` -> [wezterm](https://github.com/wez/wezterm)`Rust` -> [Alacritty](https://github.com/alacritty/alacritty)`Rust` -> [Termit](https://github.com/nonstop/termit)`C`
