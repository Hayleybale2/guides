...
## ANDROID APPS
* __Launcher__: [Rootless Pixel Launcher](https://github.com/amirzaidi/Launcher3) (1,61 MB) -> [T-UI](https://github.com/Andre1299/TUI-ConsoleLauncher) (1,5 MB) -> [Slim Launcher](https://github.com/sduduzog/slim-launcher) (1,4 MB) -> [KISS](http://kisslauncher.com/) (0,9 MB) -> [Search Based Launcher](https://github.com/vackosar/search-based-launcher/) (622 KB) -> [Light Android Launcher](https://github.com/light-launcher/Light-Android-Launcher/blob/HEAD/README.md) (242 KB) -> [Emerald Launcher](https://github.com/HenriDellal/emerald) (186 KB) -> [Last Launcher](https://github.com/SubhamTyagi/Last-Launcher) (149 KB) -> [PieLauncher](https://github.com/markusfisch/PieLauncher) (136 KB) -> [Keikai Launcher](https://github.com/KeikaiLauncher/KeikaiLauncher) (96 KB) -> [Fast](https://github.com/ligi/FAST) (75 KB) -> [T4 Launcher](https://github.com/rsteube/t4-launcher) (44 KB)
...
* __Terminal Emulator__: [Gnome Terminal](https://gitlab.gnome.org/GNOME/gnome-terminal)`C++` -> [Lxterminal](https://github.com/lxde/lxterminal)`C` -> [Sakura](https://launchpad.net/sakura)`C` -> [wezterm](https://github.com/wez/wezterm)`Rust` -> [Alacritty](https://github.com/alacritty/alacritty)`Rust` -> [Termit](https://github.com/nonstop/termit)`C` -> [tym](https://github.com/endaaman/tym)`C`
...
* __Keyboard Layout__: [KBD](https://github.com/legionus/kbd) -> [XKB](https://www.x.org/wiki/XKB/) -> xmodmap -> [keyd](https://github.com/rvaiya/keyd) 
...
* __Screenshot Information__: [Archey4](https://github.com/HorlogeSkynet/archey4)`Python` -> [screenFetch](https://github.com/KittyKatt/screenFetch)`Bash` -> [Fastfetch](https://github.com/fastfetch-cli/fastfetch)`C` -> [Alsi](https://github.com/trizen/alsi)`Perl`
...
* __Image Viewer__: [imv](https://git.sr.ht/~exec64/imv/)`C` -> display ([ImageMagick](https://github.com/ImageMagick/ImageMagick))`C` -> [sxiv](https://github.com/muennich/sxiv)`C` -> [Feh](https://feh.finalrewind.org/)`C` -> [fim](http://www.nongnu.org/fbi-improved/)`C++` -> [lsix](https://github.com/hackerb9/lsix)`BASH` -> [Swayimg](https://github.com/artemsen/swayimg)`C` -> [idump](https://github.com/uobikiemukot/idump)`C`
...
* __Screenshots__: [Shutter](https://shutter-project.org/)`Perl` -> [maim](https://github.com/naelstrof/maim)`C++` -> import (ImageMagick)`C` -> [scrot](https://github.com/resurrecting-open-source-projects/scrot)`C` -> [fbcat](https://github.com/jwilk/fbcat) (FBGrab)`C`
...
* __Wallpaper Changer (Animated)__: [wallutils](https://github.com/xyproto/wallutils)`Go` -> [swww](https://github.com/Horus645/swww)`Rust` -> [oguri](https://github.com/vilhalmer/oguri)`C`
...
* __Window Manager__: [wayfire](https://wayfire.org/) -> [labwc](https://github.com/labwc/labwc) -> [japokwm](https://github.com/werererer/japokwm) -> [cagebreak](https://github.com/project-repo/cagebreak) -> [vivarium](https://github.com/inclement/vivarium) -> [waybox](https://github.com/wizbright/waybox) -> [weston](https://gitlab.freedesktop.org/wayland/weston) -> [sawy](https://github.com/swaywm/sway) -> [waymonad](https://github.com/waymonad/waymonad) -> [hikari](https://hub.darcs.net/raichoo/hikari) -> [dwl](https://github.com/djpohly/dwl) -> [velox](https://github.com/michaelforney/velox)
* __Screenshots__: [grim](https://github.com/emersion/grim)`C` -> [wayshot](https://git.sr.ht/~shinyzenith/wayshot)`Rust` -> [shotman](https://git.sr.ht/~whynothugo/shotman)`Rust`
